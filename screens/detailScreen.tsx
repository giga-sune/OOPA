  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.bottomStickyBar}>
        ...
        <TouchableOpacity style={styles.mainRentCTAButton} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  ...
  attributeItemRow: { flexDirection: 'row', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' },
  ...
  blockSectionHeading: { ...Typography.h3, color: Colors.grayPrimary || '#0F172A', marginTop: 24, marginBottom: 12, fontWeight: '700' },
